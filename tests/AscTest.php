...
class AscTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $versions = array('2.0.0', '1.0.0', '40.0.0', '3.0.0');
        $vs = new VersionSort($versions);
        $expected = $vs->asc();
        $actual = array('1.0.0', '2.0.0', '3.0.0', '40.0.0');
    ...
    {
        $versions = array('1.1.0', '1.0.0', '1.299.0', '1.2.0');
        $vs = new VersionSort($versions);
        $expected = $vs->asc();
        $actual = array('1.0.0', '1.1.0', '1.2.0', '1.299.0');
        $this->assertEquals($expected, $actual);
    }
    ...
    {
        $versions = array('1.0.100', '1.0.1', '1.0.20', '1.0.9');
        $vs = new VersionSort($versions);
        $expected = $vs->asc();
        $actual = array('1.0.1', '1.0.9', '1.0.20', '1.0.100');
        $this->assertEquals($expected, $actual);
    }
